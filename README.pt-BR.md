...
[![Versão](https://img.shields.io/badge/versão-1.0.0-2563eb?style=flat-square)](CHANGELOG.md)
...
A versão 1.0.0 foi validada com:
...
Hashes SHA-256 aprovados para a versão 1.0.0:
